...
public class ProjectilePoolManager : MonoBehaviour
{
    ...
    private readonly Queue<IProjectileHandler> _pool = new();
    ...
    public void InstantiateProjectile(Vector3 originPoint, Vector3 direction, GunParameters gunParams)
    {
        ...
        if (!_pool.TryDequeue(out IProjectileHandler projectileHandler))
        {
        ...
        projectileHandler.ActiveBullet(parameters, _pool);
    }
}
